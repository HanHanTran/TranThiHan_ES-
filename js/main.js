...
const showGlasses = dataGlasses.reduce((value,dataGlasses) => {
    return (value +=`
    
    <img onclick="clickGlass('${dataGlasses.id}')" class="col-4" src=" ${dataGlasses.src}" alt="">
    `)
   
    
},'')
// console.log({hienthi})
document.querySelector('#vglassesList').innerHTML= showGlasses;
    ...
    const clickGlass = (id)=>{
        ...
        document.querySelector('#glassesInfo').style.display = 'inline';
    }
